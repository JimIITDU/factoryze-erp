...
exports.CreateFinishedProductDto = void 0;
var class_validator_1 = require("class-validator");
var CreateFinishedProductDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateFinishedProductDto() {
                this.name = __runInitializers(this, _name_initializers, void 0);
                this.unit = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _unit_initializers, void 0));
                this.stockQty = (__runInitializers(this, _unit_extraInitializers), __runInitializers(this, _stockQty_initializers, void 0));
                __runInitializers(this, _stockQty_extraInitializers);
            }
            return CreateFinishedProductDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _unit_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _stockQty_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.Min)(0)];
...
exports.CreateFinishedProductDto = CreateFinishedProductDto;
