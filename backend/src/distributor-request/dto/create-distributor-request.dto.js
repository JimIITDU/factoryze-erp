...
exports.CreateDistributorRequestDto = void 0;
var class_validator_1 = require("class-validator");
var class_transformer_1 = require("class-transformer");
var RequestItemDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function RequestItemDto() {
                ...
                this.quantity = __runInitializers(this, _productName_extraInitializers);
            }
...
var CreateDistributorRequestDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateDistributorRequestDto() {
                this.items = __runInitializers(this, _items_initializers, void 0);
                this.preferredDeliveryDate = (__runInitializers(this, _items_extraInitializers), __runInitializers(this, _preferredDeliveryDate_initializers, void 0));
                __runInitializers(this, _preferredDeliveryDate_extraInitializers);
            }
            return CreateDistributorRequestDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _items_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.ValidateNested)({ each: true }), (0, class_transformer_1.Type)(function () { return RequestItemDto; })];
            _preferredDeliveryDate_decorators = [(0, class_validator_1.IsDateString)(), (0, class_validator_1.IsOptional)()];
...
exports.CreateDistributorRequestDto = CreateDistributorRequestDto;
